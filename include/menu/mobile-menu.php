<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex ml-auto">
            <img alt="وب اپلیکیشن مدیریت مدیریت کتابخانه بخش کامپیوتر دانشگاه شیراز -مدیریت کتابخانه بخش کامپیوتر دانشگاه شیراز" class="w-6" src="assestPanel/dist/images/logo.png">
        </a>
