...
<div class="content">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5" >
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            ...
            <div class="w-full sm:w-auto mt-3 ml-1 sm:mt-0 sm:ml-auto md:ml-0" style="">
                <div class="w-56 relative text-gray-700 dark:text-gray-300">
                    <input type="text" id="search-data-table-listLoad" onkeyup="bookList()" class="form-control w-56 box pl-10 placeholder-theme-13" placeholder="جستجو...">
                    <i class="w-4 h-4 absolute my-auto inset-y-0 ml-3 left-0" data-feather="search" onclick="bookList()"></i>
                </div>
            </div>
        ...
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-row sm:flex-nowrap items-center" >
            ...
            <select class="w-20 form-select box mt-3 sm:mt-0" onchange="bookList()" id="limitPage">
                <option >20</option>
                <option>50</option>
                <option>35</option>
...
<script>
    ...
    async function deActive(id) {
        ...
        if(error.length==0){
            ...
            const response = await fetch('https://omid.asqtest.ir/manager/deactiveBook', {
                method: "POST",
    ...
    async function Active(id) {
        ...
        if(error.length==0){
            ...
            const response = await fetch('https://omid.asqtest.ir/manager/activeBook', {
                method: "POST",
                body: JSON.stringify(dataSend),
                headers: {"Content-type": "application/json"}
            });
...
<script>
    ...
    function bookList(){
        ...
        pagetion();
        $.ajax({
            url : 'viewModel/bookList/List.php',
            type : 'POST',
            data : {
                "keyword":keyword,
                "limit":limit,
